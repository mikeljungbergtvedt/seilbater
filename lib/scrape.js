...
// Domener som ikke funker fra cloud-IPer (Cloudflare). Disse hopper vi
// over på Vercel — lokal scraper på macen henter dem innen 15 min.
const LOCAL_ONLY_DOMAINS = /yachtworld\.com|boat24\.com|boattrader\.com|batagent\.se/i;
...
export async function scrapeUrl(url) {
  // Domener vi vet at lokale scraper må håndtere — ikke prøv fra Vercel
  if (LOCAL_ONLY_DOMAINS.test(url)) {
    throw new Error("PENDING_LOCAL");  // spesiell markør, håndteres i API
  }
